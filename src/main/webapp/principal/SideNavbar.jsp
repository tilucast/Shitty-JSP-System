...
<nav class="pcoded-navbar" style="position: fixed !important; height: 90vh;">
        ...
        <div class="">
            <div class="main-menu-header">
                ...
                <div class="user-details">
                    <span id="more-details"> ${ user.getLogin() } <i class="fa fa-caret-down"></i></span>
                </div>
            </div>
            ...
            <div class="main-menu-content">
                <ul>
                    <li class="more-details">
                        <a href="<%= request.getContextPath() %>/principal/profile.jsp"><i class="ti-user"></i>View Profile</a>
                        <a href="#!"><i class="ti-settings"></i>Settings</a>
                        <a href="/curso-jsp/ServletLogin?action=logout"><i class="ti-layout-sidebar-left"></i>Logout</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="p-15 p-b-0">
            <form class="form-material" onsubmit="popModal(event)" action="ServletCreateUser">
...
<button id="launch-modal" style="display: none; " type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  Launch demo modal
</button>
