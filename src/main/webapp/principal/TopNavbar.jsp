                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="<%= request.getContextPath() %>/<%= request.getContextPath() %>/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                          <div class="media-body">
                          ...
                          <li class="user-profile header-notification">
                              ...
                              <ul class="show-notification profile-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <a href="<%= request.getContextPath() %>/principal/profile.jsp">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <a href="/curso-jsp/ServletLogin?action=logout">
